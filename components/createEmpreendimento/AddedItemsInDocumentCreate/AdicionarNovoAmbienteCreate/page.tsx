...
import AdicionarNovoItemCreate from "./AdicionarNovoItemCreate/page";

import { itemService, marcaService } from "@/lib/api1";
...
export default function AdicionarItensDocumentoCreate({
  ...
  return (
    <div className="flex gap-3 w-full">
      ...
      <AdicionarNovoItemCreate onReload={handleReload} />
    </div>
  );
}
