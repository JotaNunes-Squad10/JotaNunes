import SelecionaAmbienteCreate from "./SelecionaAmbienteCreate/page";
import AdicionarNovoAmbienteCreate from "./AdicionarNovoAmbienteCreate/page";
import SelecioneItemAmbiente from "@/components/EmpreendimentoEditor/AddedItemsInDocument/SelecionaItemAmbiente/page";
...
export default function AddedItemsInDocumentCreate({
  ambienteSelecionado,
